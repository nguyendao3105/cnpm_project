          ...
          <div class="row overlay-white">
            <div class="col-md-6 info-section">
              ...
              <div>
                ...
                <!--Balance-->
                <p id="balance">Số dư:<?php echo $row[3]; ?> </p>
              </div>
            </div>
            <div class="col-md-6 info-section">
              <div class="section-header-small">
              ...
              <form action="info-customer.php" onsubmit="update()">
  ...
  <script type="text/javascript">
    ...
    function update()
    {
      ...
      if(amount != "" && amount != "0")
      {
        ...
        } else {alert("Vui lòng nhập số tiền, tối thiểu 1");}
