...
<html>
<head>
	<title>Trang chủ - Chủ sở hữu nhà cung cấp</title>
	<meta charset="utf-8">
	<style type="text/css">
        nav{
...
<body>
	<nav style="text-align: right; margin: -0.6%">
        ...
        <form style="display: inline" action="../signin_21/home_customer.php" method="post"><button  type="submit" name='logout' style="color: white; background-color: #333; font-size: 120%">Đăng xuất</button> </form>
    </nav>
	...
	<nav style="text-align: center; margin: -0.5%">
    	<a href="../signin_21/home_customer.php">TRANG CHỦ </a> &emsp;&emsp;&emsp;
        <a href="">XEM BÁO CÁO</a>&emsp;&emsp;&emsp;
        <a href="">MENU</a>&emsp;&emsp;&emsp;
        <a href="">NHÂN SỰ</a>&emsp;&emsp;&emsp;
